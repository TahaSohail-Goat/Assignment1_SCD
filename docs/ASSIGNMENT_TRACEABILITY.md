...
| ASG-DOC-016 | §4 J p22; §5.2 p23 | `docs/ENGINEERING-NOTES.md` answers all eight questions with references to the team's own files and lines (generic answers score zero) | Mandatory | Artfever | #54 | `docs/ENGINEERING-NOTES.md` | DOC | `docs/ENGINEERING-NOTES.md` | Partial: Q8 needs a factual >1-hour incident from a contributor |
...
| ASG-DOC-024 | §5.2 p24 | EN-Q8: a failure that cost > 1 hour — symptoms, wrong first belief, the exact command/log line that revealed the truth | Evidence | Artfever | #54 | notes | DOC | `docs/ENGINEERING-NOTES.md` | Partial: Q8 needs a factual >1-hour incident from a contributor |
