...
| ASG-FR-009 | §2.1 p4 | Dashboard: operator can advance status | Mandatory | Artfever | #35 | `frontend/src/pages/` | UT | `frontend/src/pages/Dashboard.tsx` | Implemented (#35); screenshot pending |
| ASG-FR-010 | §2.1 p4; §4 B p19 | An invalid transition surfaces the server's 409 message (verbatim), not a generic "error" | Mandatory | Artfever | #35 | `frontend/src/pages/` | UT | `frontend/src/pages/Dashboard.tsx` | Implemented (#35); test and screenshot pending |
