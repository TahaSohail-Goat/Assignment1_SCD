...
| ASG-DEVOPS-010 | §3.1 p12 | Report both stage sizes; a frontend image over ~60 MB indicates the multi-stage split is not working | Evidence | TahaSohail-Goat | #53 | `README.md` / notes | MEAS | size capture, `docs/evidence/container-sizes.md` | Frontend stage measurement added to CI; numerical result pending |
...
| ASG-DEVOPS-012 | §3.1 p12 | Report build-context size before and after `.dockerignore`, with numbers | Evidence | TahaSohail-Goat | #53 | notes | MEAS | size capture, `docs/evidence/container-sizes.md` | Frontend context measurement added to CI; numerical result pending |
