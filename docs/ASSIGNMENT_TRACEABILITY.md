...
| ASG-CICD-011 | §4 I p21 | `ci.yml` checks configured as required checks on main | Mandatory | TahaSohail-Goat | #51 | repo settings | DEMO | screenshot | Configured 2026-09-26: ten `ci.yml` job names required on `main` and `dev`; export in `docs/evidence/ruleset-*.json`; screenshot pending (P12-S02) |
