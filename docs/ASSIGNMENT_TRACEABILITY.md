...
| ASG-GH-006 | §4 A p19 | ≥ 35 commits | Mandatory | TahaSohail-Goat | #56 | git history | MEAS | `git shortlog -sn` | Done: 156 commits on origin/dev at a4cd0b9 by git shortlog -sn, threshold 35 |
...
| ASG-GH-008 | §4 A p19 | Neither partner below 35% by `git shortlog -sn` | Mandatory | TahaSohail-Goat | #56 | git history | MEAS | `git shortlog -sn` | FAIL at audit baseline: git shortlog -sn origin/dev (a4cd0b9) gives Taha 109 / Artfever 47 (30.1%), threshold 35%. Refresh after #107 and final promotion |
