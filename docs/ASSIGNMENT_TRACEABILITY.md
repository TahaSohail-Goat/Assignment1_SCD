...
| ASG-DOC-024 | §5.2 p24 | EN-Q8: a failure that cost > 1 hour — symptoms, wrong first belief, the exact command/log line that revealed the truth | Evidence | Artfever | #54 | notes | DOC | `docs/ENGINEERING-NOTES.md` | Written with source/line references; >1-hour duration confirmed by Artfever; partner review pending |
