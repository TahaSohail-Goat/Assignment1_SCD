...
| ASG-FR-007 | §2.1 p4 | Submit view renders the loading state honestly (AI calls take seconds) | Mandatory | Artfever | #35 | `frontend/src/pages/` | UT | `frontend/tests/views.test.tsx` | Implemented and delayed-request test passed (#35/#36) |
...
| ASG-FR-011 | §2.1 p4 | Stats view: aggregate counts by category and priority | Mandatory | Artfever | #36 | `frontend/src/pages/` | UT | `frontend/tests/views.test.tsx` | Implemented (#36); screenshot pending |
| ASG-FR-012 | §2.1 p4 | Stats view displays whether the response was a cache hit, from the X-Cache header | Mandatory | Artfever | #36 | `frontend/src/pages/` | UT | `frontend/tests/views.test.tsx` | Implemented (#36); HIT/MISS/missing tested |
...
| ASG-NFR-014 | §3.4 p17; §4 B p19 | ≥ 5 meaningful frontend component tests (Vitest) passing in CI | Mandatory | Artfever | #36 | `frontend/tests/` | CI | `frontend/tests/views.test.tsx` (9 passing locally) | Implemented (#36); CI run pending #51 |
